      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            ...
            :key="index"
            class="relative group cursor-pointer overflow-hidden rounded-2xl border border-navy/10 bg-white/80 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/0 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
              <div class="w-full px-6 pb-6 text-left text-white">
            ...
            <!-- Category Badge -->
            <div class="absolute top-4 right-4 bg-muted-red text-white px-3 py-1 rounded-full text-xs font-semibold shadow">
              {{ photo.category }}
            </div>
          </div>
        </div>
...
import gallerySports from '@/assets/gallery/setho3.jpg'
import galleryCommunity from '@/assets/gallery/gath3.jpg'
